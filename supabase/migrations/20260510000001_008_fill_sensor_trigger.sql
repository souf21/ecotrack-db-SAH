...
-- Backfill: create sensors for any existing bins that don't have one yet
DO $$
DECLARE
  r RECORD;
  v_capteur_id uuid;
...
-- Reliable function: latest fill % per container (uses DISTINCT ON, no client-side limit tricks)
